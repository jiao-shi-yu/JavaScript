...
![JavaScript syntax for invoking a function with arguments as variables](../image/by_variable.svg)
...
![comparing single line and multiline arrow functions](../image/return.svg)
